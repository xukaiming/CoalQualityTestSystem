...
///////////////////////////////////////////////////////////////////////////////
	...
	XLISTCTRLLIBDLLEXPORT UINT WM_XLISTCTRL_DATETIMECTRL_SELECTION;
	...
	extern UINT WM_XLISTCTRL_DATETIMECTRL_SELECTION;
...
struct XLISTCTRLDATA
{
	...
	XLISTCTRLDATA()
	{
		...
		//////////////////////////////////////////
		bDateTimeCtrl		= FALSE;			// TRUE = display DateTimePicker 
		m_dt				= COleDateTime::GetCurrentTime();						//datetime for datetime
		nDateTimeCtrlHeight	= 10;				// datetime height (in rows)
	...
	// for DateTimePicker
	BOOL			bDateTimeCtrl;			// TRUE = display DateTimePicker 
	COleDateTime	m_dt;						//datetime for datetime
	int				nDateTimeCtrlHeight;	// datetime height (in rows)
	// that the list will be re-sorted on
	// each AddString()
...
public:
	...
	BOOL	SetComboBox(int nItem, 
						...
						BOOL bSort = FALSE);	//+++
	BOOL	SetDatetimeCtrl(int nItem, 
						int nSubItem, 
						BOOL bEnableCombo, 
...
#endif
#ifndef DO_NOT_INCLUDE_XDATETIMEPICKER
	void	DrawDateTimePicker(int nItem, 
		int nSubItem);
#endif
...
#ifndef DO_NOT_INCLUDE_XDATETIMEPICKER	//-----------------------------------------
	BOOL			m_bDateTimePickerIsClicked;
	int				m_nDateTimePickerItem;
	int				m_nDateTimePickerSubItem;
	CRect			m_rectDateTimePickerButton; 
	CXDateTimeCtrl *	m_pDateTimePicker;
	CFont			m_DateTimeFont;
	BOOL			m_bDateTimeFontIsCreated;
#endif	//---------------------------------------------------------------------
...
#ifndef DO_NOT_INCLUDE_XDATETIMEPICKER
	//afx_msg void OnTimer(UINT nIDEvent);
	afx_msg LRESULT OnDateTimeCtrlEscape(WPARAM, LPARAM);
	afx_msg LRESULT OnDateTimeCtrlComplete(WPARAM, LPARAM);
#endif
